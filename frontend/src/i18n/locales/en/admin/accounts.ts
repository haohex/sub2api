export default {
    accounts: {
      statePool: {
        ...
        description: 'Candidates are isolated by account and upstream model. Pro / Plus use 292 bytes; Team uses 332. Candidates last one hour and renew five minutes before expiry. Each model has 25 attempts of 10 seconds; a missing HTTP state switches probing to fresh WS connections.',
      ...
      openai: {
        ...
        codexTurnStateProbeDesc: "Candidates are isolated by account and upstream model. Pro / Plus use 292 bytes; Team uses 332. Candidates last one hour and renew five minutes before expiry. Each model has 25 attempts of 10 seconds; a missing HTTP state switches probing to fresh WS connections.",
