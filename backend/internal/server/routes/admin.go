...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.POST("/:id/codex-turn-state-probe/refresh", h.Admin.Account.RefreshCodexState)
		accounts.GET("/:id/codex-turn-state-probe/state", h.Admin.Account.GetCodexStateValue)
