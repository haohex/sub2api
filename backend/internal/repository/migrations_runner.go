...
var migrationChecksumCompatibilityRules = map[string]migrationChecksumCompatibilityRule{
	...
	// The Plus v0.2.1+custom.003 branch applied this retry-safe version. Keep
	// existing KlN .2 databases compatible with the pre-retry file checksum;
	// all other checksum mismatches remain fail-closed.
	"226_channel_monitor_quota_mode.sql": newMigrationChecksumCompatibilityRule(
		"c01c87739b5b0b10ee0f21c89e9652d10106c639d131484e4ad39f72cc7b586c",
