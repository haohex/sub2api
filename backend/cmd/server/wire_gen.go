...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	codexTurnStateProbeService := service.ProvideCodexTurnStateProbeService(accountRepository, proxyRepository, openAITokenProvider, httpUpstream, openAIGatewayService, settingRepository)
