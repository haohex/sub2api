...
<a href="https://trendshift.io/repositories/21823" target="_blank"><img src="https://trendshift.io/api/badge/repositories/21823" alt="luohao830%2Fsub2api | Trendshift" width="250" height="55"/></a>
...
```bash
curl -sSL https://raw.githubusercontent.com/luohao830/sub2api/main/deploy/install.sh | sudo bash
```
...
# Uninstall
curl -sSL https://raw.githubusercontent.com/luohao830/sub2api/main/deploy/install.sh | sudo bash -s -- uninstall -y
```
...
curl -sSL https://raw.githubusercontent.com/luohao830/sub2api/main/deploy/docker-deploy.sh | bash
...
git clone https://github.com/luohao830/sub2api.git
cd sub2api/deploy
...
<a href="https://star-history.dera.page/#luohao830/sub2api&Date">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://star-history.dera.page/svg?repos=luohao830/sub2api&type=Date&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://star-history.dera.page/svg?repos=luohao830/sub2api&type=Date" />
   <img alt="Star History Chart" src="https://star-history.dera.page/svg?repos=luohao830/sub2api&type=Date" />
 </picture>
</a>
